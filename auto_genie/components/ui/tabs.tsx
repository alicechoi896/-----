  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-white data-active:text-violet-700 data-active:border-neutral-200 dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground",
